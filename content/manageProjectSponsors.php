                            ...
                            ?>
                                <table class="table table-striped">
                                    ...
                                    <?php
                                        ...
                                        {
                                            ?>
                                                <tr><td><img src="<?php echo $sponsor["sponsor"]->getFullLogo(); ?>" style="max-width:100px;max-height:100px;"/></td><td><?php echo $sponsor["sponsor"]->getName(); ?></td><td><?php echo $sponsor["type"]; ?></td><td><a href="?mode=changeSponsorType&sponsorId=<?php echo $sponsor['sponsor']->getId(); ?>&projectId=<?php echo $project->getId(); ?>" alt="Switch type" class="btn btn-info btn-sm"><span class="glyphicon glyphicon-refresh"></span></a><a href="?mode=edit&type=sponsor&id=<?php echo $sponsor['sponsor']->getId(); ?>&project=<?php echo $_GET['id']; ?>" class="btn btn-sm btn-warning"><span class="glyphicon glyphicon-pencil"></span></a><a href="?mode=remove&type=sponsorLink&sponsorId=<?php echo $sponsor['sponsor']->getId(); ?>&projectId=<?php echo $project->getId(); ?>" class="btn btn-danger btn-sm"><span class="
