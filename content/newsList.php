...
<script>
    ...
    $(document).ready(function() {
        $("#results").load("ajax/getNewsList.php", {'page':0,'numberPerPage':numberPerPage}, function() {$("#1-pagination-li").addClass('active');}).slideDown(4000);  //initial page number to load
        ...
        $(".paginate_click").click(function (e) {
            ...
            $("#results").load("ajax/getNewsList.php", {'page': (page_num-1)}, function(){
        ...
        $("#pagination-li-previous").click(function (e){
            ...
            $("#results").load("ajax/getNewsList.php", {'page': (page_num-1), <?php if(isset($_GET['username'])){echo "'username':'".$_GET['username']."'";} ?>}, function(){
